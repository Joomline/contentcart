...
<?php } ?>
<input type="submit" class="btn btn-primary" value="<?php echo JText::_('CONTENTCART_ADD_TO_CART')?>" />
<input type="number" name="count" max="999" min="1" value="1" >
</form>

<?php } 

elseif (!JFactory::getApplication()->input->getInt('cart')  && $link != $cart_url) { ?>
	<div class="to-cart"><a class="btn btn-success" href="<?php echo $cart_url;?>"><?php echo JText::_('CONTENTCART_GO_TO_CART')?></a></div>
<?php } ?>
